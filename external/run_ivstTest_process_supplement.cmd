...
if not exist "C:\Users\Tom\Documents\Projects\CodeReader\ivstTest\captures_incremental" mkdir "C:\Users\Tom\Documents\Projects\CodeReader\ivstTest\captures_incremental"
...
set STATUS_FILE=C:\Users\Tom\Documents\Projects\CodeReader\ivstTest\logs\run_process_supplement.status.txt

echo started %date% %time% > "%STATUS_FILE%"
echo [ivstTest] process supplement started
"C:\Users\Tom\Documents\Projects\CodeReader\tools\python310_embed\python.exe" "C:\Users\Tom\Documents\Projects\CodeReader\external\obs_glm_ocr_sync.py" ^
  --config "C:\Users\Tom\Documents\Projects\CodeReader\config\ivstTest_obs_glm_ocr_segmented_supplement.json"

set EXIT_CODE=%ERRORLEVEL%
echo finished %date% %time% exit=%EXIT_CODE% > "%STATUS_FILE%"
echo [ivstTest] process supplement finished with exit=%EXIT_CODE%
exit /b %EXIT_CODE%
